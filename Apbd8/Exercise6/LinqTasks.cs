...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = Emps.Where(e => e.Salary.Equals(Emps.Max(e => e.Salary)));
            return result;
        }
        ...
        {
            IEnumerable<object> result = Emps.Join(Depts, emp => emp.Deptno,
                dept => dept.Deptno, (emp, dept) => new
                {
                    Ename = emp.Ename,
                    Job = emp.Job, 
                    Dname = dept.Dname
        ...
        {
            bool result = Emps.Any(e => e.Job.Equals("Frontend programmer"));
            return result;
        }
        ...
        {
            IEnumerable<object> result = Depts.GroupJoin(Emps, dept => dept.Deptno, emp => emp.Deptno, (dept, emps) => new
            {
                Name = dept.Dname, 
        ...
        {
            IEnumerable<Emp> result = CustomExtensionMethods.MyMethod(Emps);
            return result;
        }
    ...
    public static class CustomExtensionMethods
    {
        ...
        /// Metoda powinna zwrócić tylko tych pracowników, którzy mają min. 1 bezpośredniego podwładnego.
        /// Pracownicy powinny w ramach kolekcji być posortowani po nazwisku (rosnąco) i pensji (malejąco).
        public static IEnumerable<Emp> MyMethod(this IEnumerable<Emp> employees)
        {
            return employees.Where(emp => employees.Any(e => e.Mgr == emp))
